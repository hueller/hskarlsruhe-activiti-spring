...
public class HomeController {
    ...
    public String home(Model model, 
        ...
        Collection<TwitterMessage> twitterMessages = twitterService.getTwitterMessages();
        ...
        if (retweet != null && tweetId != null) {
            ...
            if (null != message) {
                // Start process
                LOG.info("Start twitter process for tweet id {}.", tweetId);
                processService.start(message);
                
                // Remove message from collection
                twitterMessages.remove(message);
                model.addAttribute("twitterMessages", twitterMessages);
            } else {
